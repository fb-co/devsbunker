        ...
        <div class='main_container' style="margin-left: 25px;">
            <div class="row1">
                <div class='profile_pic_container row_item'>
                    ...
                    <p class="username">{{ this.$store.getters.username }}   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-patch-check-fll" fill="#3C93D2" xmlns="http://www.w3.org/2000/svg">
