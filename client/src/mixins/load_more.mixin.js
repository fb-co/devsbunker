...
const LoadMore = {
    ...
    methods: {
        ...
        async getPosts(filter) {
            ...
            const alreadyLoadedPosts = this.$store.getters.getPosts(filter || this.sortingType, this.queryType, this.otherData);
            ...
            if (alreadyLoadedPosts) {
                ...
                if (this.queryType === "all") {
                    const res = await GraphQLPostsService.fetchPosts(
                    ...
                    const res = await GraphQLPostsService.fetchSavedPosts(
                        this.getLastPostId(),
                        this.getLastPostUniqueField(),
                        filter || this.sortingType,
                        this.$store.getters.accessToken
                    ...
                    const res = await GraphQLPostsService.fetchTargetedPosts(
                        this.getLastPostId(),
                        this.getLastPostUniqueField(),
                        this.$store.getters.accessToken
                    );
        ...
        async loadNewPosts(filter) {
            if (this.queryType === "all") {
                ...
                const res = await GraphQLPostsService.fetchTargetedPosts(this.getLastPostId(), this.getLastPostUniqueField(), this.$store.getters.accessToken);
                if (!res.errors) {
                    this.posts = this.posts.concat(res.data.getTargetedPosts.posts);
                    this.fetchedAll = res.data.getTargetedPosts.fetchedAll;
